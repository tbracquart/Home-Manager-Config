...
in
{
  ...
  audio = {
    enable_sounds = true;
    sound_volume = 0.99999997764825821;
  };
  ...
  dock = {
    ...
    pinned = [ "firefox" "org.kde.dolphin" "kitty" "org.kde.kate" "netflix-via-google-chrome" ];
    reserve_space = false;
    show_dots = true;
  ...
  theme = {
    ...
    templates = {
      builtin_ids = [ "btop" "hyprland" "kitty" ];
      community_ids = [ "zen-browser" "vscode" "bat" "hyprtoolkit" ];
    };
  };
